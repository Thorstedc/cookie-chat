...
$scope.getMessages = function() {
  $scope.messages = messageService.getMessages().then(function(data2) {
    $scope.messages = data2.data
...
$scope.postMessage = function(val){
  console.log(val)
  messageService.postMessages(val).then(function(){
